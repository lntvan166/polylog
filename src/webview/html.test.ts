...
{
  for (const id of ["app", "repo-pane", "repo-filter", "repo-rows", "splitter", "modebar", "mode-all", "history-path", "history-close", "filters", "search", "author", "me", "path", "branch", "branch-list", "branch-use", "date", "custom-range", "from", "to", "refresh", "notices", "list", "rows", "empty", "more", "count"]) {
