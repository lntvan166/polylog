...
{
  for (const id of ["filters", "search", "author", "me", "repo-button", "repo-menu", "repo-search", "repo-all", "repo-none", "repo-list", "date", "custom-range", "from", "to", "refresh", "notices", "list", "rows", "empty", "more", "count"]) {
