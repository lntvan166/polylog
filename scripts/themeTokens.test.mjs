...
{
  // charts.orange is VS Code's alias of minimap.findMatchHighlight: translucent in light
  // and dark themes and undefined in high contrast, so anything painted with it disappears.
